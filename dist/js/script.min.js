...
Object(_modules_check_inputs__WEBPACK_IMPORTED_MODULE_14__["default"])(); //Up arrow
...
upElem.addEventListener('click', function (e) {
  e.preventDefault();
  Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_15__["default"])(upElem);
}); //Footer links

var footerItems = document.querySelectorAll('.footer__link');
footerItems.forEach(function (item) {
  item.addEventListener('click', function (e) {
    e.preventDefault();
    var target = e.target;
    Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_15__["default"])(target);
  });
});
...
var menuBurger = function menuBurger() {
  ...
  hamburger.addEventListener('click', function () {
    ...
    menuBody.classList.toggle('active'); //! если не надо блокировать задний фон - убрать!
  ...
  menuItem.forEach(function (item) {
    item.addEventListener('click', function (e) {
      ...
      if (hamburger.classList.contains('active')) {
        ...
        menuBody.classList.remove('active'); //! если не надо блокировать задний фон - убрать!
      ...
      Object(_scroll__WEBPACK_IMPORTED_MODULE_0__["default"])(target);
    });
  });
};
...
var form = function form() {
  var forms = document.querySelectorAll('.form'); //==============Сообщения о ходе отправки==================

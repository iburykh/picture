...
/* harmony import */ var _modules_menuBurger__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/menuBurger */ "./src/js/modules/menuBurger.js");
/* harmony import */ var _modules_sliderAuto__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/sliderAuto */ "./src/js/modules/sliderAuto.js");
...
/* harmony import */ var _modules_formCalc__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/formCalc */ "./src/js/modules/formCalc.js");
...
Object(_modules_menuBurger__WEBPACK_IMPORTED_MODULE_3__["default"])('.menu', '.menu__sublink', '.hamburger', true);
Object(_modules_sliderAuto__WEBPACK_IMPORTED_MODULE_4__["default"])();
Object(_modules_showMore__WEBPACK_IMPORTED_MODULE_5__["default"])();
Object(_modules_upload__WEBPACK_IMPORTED_MODULE_6__["default"])();
Object(_modules_formCalc__WEBPACK_IMPORTED_MODULE_7__["default"])();
...
var pictureSize = function pictureSize() {
  ...
  function showImg(block) {
    var img = block.querySelector('img'); // отрезаем от пути к картинке 4 символа slice(0, -4) и подставляем '-1.png' (новый адрес с новой картинкой)
...
var spoilers = function spoilers() {
  var btns = document.querySelectorAll('.questions__btn');
  btns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      var spollersBlock = this.closest('.questions__spoilers');
      ...
      if (!spollersBlock.querySelectorAll('.slide').length) {
        if (oneSpoller && !this.classList.contains('active')) {
          var spollerActive = spollersBlock.querySelector('.questions__btn.active');
